...
Игра «Три в ряд». Приложение реализует логику и интерфейс для игры с несколькими уровнями сложности, таблицу лидеров, обработку свапов и обновлений поля, а также автоматическая маркировка проигрыша для неактивных игр.

Игра поддерживает конфигурацию уровней (простой, средний, сложный, кастомный), где предметы обозначаются буквами алфавита. Включает проверку на возможность хода, цепные реакции уничтожений, и Swagger-документацию для API.
